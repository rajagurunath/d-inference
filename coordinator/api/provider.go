...
func (s *Server) handleCompleteAt(
	...
	if consumerGone {
		...
		//
		// Batch is exempt for the same reason it is in noteInferenceSuccess: the
		// capacity-503 rate window is an ONLINE routing signal, and neither its
		// numerator nor its denominator may move on an attempt online traffic
		// never made.
